...
public class BikeTrainer extends AbstractActionDevice implements TurnableDevicesInterface {
    public BikeTrainer(Floor floor, String deviceName, int durationOfUsing, Consumption consumption) {
