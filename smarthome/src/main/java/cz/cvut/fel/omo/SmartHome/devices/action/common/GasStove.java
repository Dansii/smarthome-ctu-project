...
public class GasStove extends AbstractActionDevice implements TurnableDevicesInterface {

    public GasStove(Floor floor, String deviceName, int durationOfUsing, Consumption consumption) {
