...
public class Turntable extends AbstractActionDevice implements TurnableDevicesInterface {


    public Turntable(Floor floor, String deviceName, int durationOfUsing, Consumption consumption) {
