...
public class Treadmill extends AbstractActionDevice implements TurnableDevicesInterface {

    public Treadmill(Floor floor, String deviceName, int durationOfUsing, Consumption consumption) {
