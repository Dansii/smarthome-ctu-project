...
public class Projector extends AbstractActionDevice implements TurnableDevicesInterface {
    public Projector(Floor floor, String deviceName, int durationOfUsing, Consumption consumption) {
