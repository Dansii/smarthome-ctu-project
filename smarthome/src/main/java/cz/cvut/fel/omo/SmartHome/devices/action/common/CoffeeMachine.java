...
public class CoffeeMachine extends AbstractActionDevice implements TurnableDevicesInterface {

    public CoffeeMachine(Floor floor, String deviceName, int durationOfUsing, Consumption consumption) {
